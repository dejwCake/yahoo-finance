...
class StockQuoteFactoryTest extends TestCase
{
    public function testCanGetFromJson(): void
    {
        ...
        $this->assertSame('AAPL', $stockQuote->getSymbol());
        $this->assertSame('en-US', $stockQuote->getLanguage());
        $this->assertSame('US', $stockQuote->getRegion());
        $this->assertSame('EQUITY', $stockQuote->getQuoteType());
        $this->assertSame('Nasdaq Real Time Price', $stockQuote->getQuoteSourceName());
        $this->assertSame(true, $stockQuote->getTriggerable());
        $this->assertSame('USD', $stockQuote->getCurrency());
        $this->assertSame('Apple Inc.', $stockQuote->getShortName());
        $this->assertSame('POST', $stockQuote->getMarketState());
        $this->assertSame('NMS', $stockQuote->getExchange());
        $this->assertSame('Apple Inc.', $stockQuote->getLongName());
        $this->assertSame('finmb_24937', $stockQuote->getMessageBoardId());
        $this->assertSame('America/New_York', $stockQuote->getExchangeTimezoneName());
        $this->assertSame('EDT', $stockQuote->getExchangeTimezoneShortName());
        $this->assertSame(-14400000, $stockQuote->getGmtOffSetMilliseconds());
        $this->assertSame('us_market', $stockQuote->getMarket());
        $this->assertSame(false, $stockQuote->getEsgPopulated());
        $this->assertSame(5.61, $stockQuote->getEpsTrailingTwelveMonths());
        $this->assertSame(6.12, $stockQuote->getEpsForward());
        $this->assertSame(5.73, $stockQuote->getEpsCurrentYear());
        $this->assertSame(26.438046, $stockQuote->getPriceEpsCurrentYear());
        $this->assertSame(16406400000, $stockQuote->getSharesOutstanding());
        $this->assertSame(3.841, $stockQuote->getBookValue());
        $this->assertSame(145.70555, $stockQuote->getFiftyDayAverage());
        $this->assertSame(5.7844543, $stockQuote->getFiftyDayAverageChange());
        $this->assertSame(0.039699614, $stockQuote->getFiftyDayAverageChangePercent());
        $this->assertSame(140.34676, $stockQuote->getTwoHundredDayAverage());
        $this->assertSame(11.1432495, $stockQuote->getTwoHundredDayAverageChange());
        $this->assertSame(0.079397984, $stockQuote->getTwoHundredDayAverageChangePercent());
        $this->assertSame(2485405614080, $stockQuote->getMarketCap());
        $this->assertSame(24.75327, $stockQuote->getForwardPE());
        $this->assertSame(39.44025, $stockQuote->getPriceToBook());
        $this->assertSame(15, $stockQuote->getSourceInterval());
        $this->assertSame(0, $stockQuote->getExchangeDataDelayedBy());
        $this->assertSame('1.9 - Buy', $stockQuote->getAverageAnalystRating());
        $this->assertSame(345479400000, $stockQuote->getFirstTradeDateMilliseconds());
        $this->assertSame(2, $stockQuote->getPriceHint());
        $this->assertSame(1.4700012, $stockQuote->getRegularMarketChange());
        $this->assertSame(0.9798701, $stockQuote->getRegularMarketChangePercent());
        $this->assertSame('2021-11-03T20:00:03+00:00', $stockQuote->getRegularMarketTime()->toAtomString());
        $this->assertSame(151.49, $stockQuote->getRegularMarketPrice());
        $this->assertSame(151.97, $stockQuote->getRegularMarketDayHigh());
        $this->assertSame('149.83 - 151.97', $stockQuote->getRegularMarketDayRange());
        $this->assertSame(149.83, $stockQuote->getRegularMarketDayLow());
        $this->assertSame(51035964, $stockQuote->getRegularMarketVolume());
        $this->assertSame(150.02, $stockQuote->getRegularMarketPreviousClose());
        $this->assertSame(-0.039615035, $stockQuote->getPostMarketChangePercent());
        $this->assertSame('2021-11-03T20:51:49+00:00', $stockQuote->getPostMarketTime()->toAtomString());
        $this->assertSame(151.43, $stockQuote->getPostMarketPrice());
        $this->assertSame(-0.060012817, $stockQuote->getPostMarketChange());
        $this->assertSame(151.5, $stockQuote->getBid());
        $this->assertSame(151.51, $stockQuote->getAsk());
        $this->assertSame(11, $stockQuote->getBidSize());
        $this->assertSame(11, $stockQuote->getAskSize());
        $this->assertSame('NasdaqGS', $stockQuote->getFullExchangeName());
        $this->assertSame('USD', $stockQuote->getFinancialCurrency());
        $this->assertSame(150.39, $stockQuote->getRegularMarketOpen());
        $this->assertSame(75443843, $stockQuote->getAverageDailyVolume3Month());
        $this->assertSame(76612900, $stockQuote->getAverageDailyVolume10Day());
        $this->assertSame(39.140007, $stockQuote->getFiftyTwoWeekLowChange());
        $this->assertSame(0.34837568, $stockQuote->getFiftyTwoWeekLowChangePercent());
        $this->assertSame('112.35 - 157.26', $stockQuote->getFiftyTwoWeekRange());
        $this->assertSame(-5.769989, $stockQuote->getFiftyTwoWeekHighChange());
        $this->assertSame(-0.03669076, $stockQuote->getFiftyTwoWeekHighChangePercent());
        $this->assertSame(112.35, $stockQuote->getFiftyTwoWeekLow());
        $this->assertSame(157.26, $stockQuote->getFiftyTwoWeekHigh());
        $this->assertSame('2021-11-11T00:00:00+00:00', $stockQuote->getDividendDate()->toAtomString());
        $this->assertSame('2021-10-28T16:30:00+00:00', $stockQuote->getEarningsTimestamp()->toAtomString());
        $this->assertSame('2022-01-25T10:59:00+00:00', $stockQuote->getEarningsTimestampStart()->toAtomString());
        $this->assertSame('2022-01-31T12:00:00+00:00', $stockQuote->getEarningsTimestampEnd()->toAtomString());
        $this->assertSame(0.85, $stockQuote->getTrailingAnnualDividendRate());
        $this->assertSame(27.003565, $stockQuote->getTrailingPE());
        $this->assertSame(0.0056659114, $stockQuote->getTrailingAnnualDividendYield());
        $this->assertSame(false, $stockQuote->getTradeable());
        $this->assertSame('Apple', $stockQuote->getDisplayName());
    }
    ...
    public function testCanGetCollection(): void
    {
        ...
        $stockQuoteCollection->each(function (StockQuote $stockQuote): void {
            $this->assertContains($stockQuote->getSymbol(), ['AAPL', 'VTI']);
        });
    }
