...
namespace DejwCake\YahooFinance\Tests\Unit\Models\ResponseModels;
...
class StockHistoryTest extends TestCase
{
    public function testCanGetFromJson(): void
    {
        ...
        $stockHistory = StockHistory::fromJson($json);
    ...
    public function testCanGetCollection(): void
    {
        ...
        $stockHistoryCollection = StockHistory::collectionFromJson($json);
    ...
    public function getCases(): array
    {
        return [
            ...
            'MissingChartPreviousClose' => [
                'json' => '{"end":null,"start":null,"previousClose":null,"symbol":"AAPL","dataGranularity":300,"close":[141.91,142.83,141.5,142.65,139.14,141.11,142,143.29,142.9,142.81,141.51,140.91,143.76,144.84,146.55,148.76,149.26,149.48,148.69,148.64,149.32,148.85],"timestamp":[1632835800,1632922200,1633008600,1633095000,1633354200,1633440600,1633527000,1633613400,1633699800,1633959000,1634045400,1634131800,1634218200,1634304600,1634563800,1634650200,1634736600,1634823000,1634909400,1635168600,1635255000,1635364803]}',
            ],
            'MissingDataGranularity' => [
                'json' => '{"end":null,"start":null,"previousClose":null,"chartPreviousClose":145.37,"symbol":"AAPL","close":[141.91,142.83,141.5,142.65,139.14,141.11,142,143.29,142.9,142.81,141.51,140.91,143.76,144.84,146.55,148.76,149.26,149.48,148.69,148.64,149.32,148.85],"timestamp":[1632835800,1632922200,1633008600,1633095000,1633354200,1633440600,1633527000,1633613400,1633699800,1633959000,1634045400,1634131800,1634218200,1634304600,1634563800,1634650200,1634736600,1634823000,1634909400,1635168600,1635255000,1635364803]}',
            ],
            'MissingTimestamp' => [
